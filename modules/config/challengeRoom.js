...
export const ROOMS = {  
  ...
  room3: { 
    ...
    platforms: [
        ...
        { x: 1350, y: 460, width: 180, height: 20 },
        { x: 1900, y: 400, width: 180, height: 20 },
        { x: 2450, y: 370, width: 180, height: 20 },
        { x: 3000, y: 410, width: 180, height: 20 },
        { x: 3550, y: 440, width: 180, height: 20 },
        { x: 4100, y: 410, width: 180, height: 20 },
        { x: 4650, y: 370, width: 180, height: 20 },
        { x: 5200, y: 450, width: 180, height: 20 },
        { x: 5700, y: 400, width: 180, height: 20 },
  ...
  room4: {
    ...
    platforms: [
            { x: 800, y: 440, width: 175, height: 20 },
            { x: 1350, y: 400, width: 175, height: 20 },
            { x: 1900, y: 410, width: 175, height: 20 },
            { x: 2450, y: 460, width: 175, height: 20 },
            { x: 3000, y: 430, width: 175, height: 20 },
            { x: 3550, y: 450, width: 175, height: 20 },
            { x: 4100, y: 420, width: 175, height: 20 },
            { x: 4650, y: 470, width: 175, height: 20 },
            { x: 5200, y: 450, width: 175, height: 20 },
            { x: 5700, y: 400, width: 175, height: 20 },
  ...
  room5: {
    ...
    platforms: [
        { x: 800, y: 460, width: 170, height: 20 },
        { x: 1350, y: 440, width: 170, height: 20 },
        { x: 1900, y: 470, width: 170, height: 20 },
        { x: 2450, y: 440, width: 170, height: 20 },
        { x: 3000, y: 460, width: 170, height: 20 },
        { x: 3550, y: 430, width: 170, height: 20 },
        { x: 4100, y: 470, width: 170, height: 20 },
        { x: 4650, y: 450, width: 170, height: 20 },
        { x: 5200, y: 470, width: 170, height: 20 },
        { x: 5700, y: 440, width: 170, height: 20 },
